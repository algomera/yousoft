<?php
	...
	class MessagesController extends Controller
	{
		...
		public function pusherAuth(Request $request) {
			...
			if (Auth::check()) {
				return Chatify::pusherAuth($request['channel_name'], $request['socket_id'], $authData);
			}
			// if not authorized
		...
		public function fetch(Request $request) {
			...
			foreach ($messages->reverse() as $index => $message) {
				$allMessages .= Chatify::messageCard(Chatify::fetchMessage($message->id, $index));
			}
