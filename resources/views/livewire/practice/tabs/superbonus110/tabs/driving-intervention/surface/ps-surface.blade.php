				...
				<tr class="bg-gray-50">
					<x-table.td class="!py-1.5" colspan="10">
						<div class="flex items-center space-x-2">
							<div>
								<span>Totale "Pavimenti": </span><span class="font-semibold">{{ $surfaces->sum('surface') }} m²</span>
							</div>
							<div>
								<span>di cui realizzati SAL n.1 </span>
								<div class="inline-block w-32">
									<x-input x-on:blur="$wire.saveSurfaceSal()" wire:model.defer="sal_1"
									         type="number" class="py-1 font-bold" name="sal_1"
							...
							<div>
								<span>SAL n.2 </span>
								<div class="inline-block w-32">
									<x-input x-on:blur="$wire.saveSurfaceSal()" wire:model.defer="sal_2"
									         type="number" class="py-1 font-bold" name="sal_2"
							...
							<div>
								<span>SAL F. </span>
								<div class="inline-block w-32">
									<x-input x-on:blur="$wire.saveSurfaceSal()" wire:model.defer="sal_f"
									         type="number" class="py-1 font-bold" name="sal_f"
